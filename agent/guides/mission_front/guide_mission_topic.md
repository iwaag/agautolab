...
If the requester have clearly said that mission can be started, create file "start.flag".
If the requester have clearly said that mission should be cancelled, create file "cancel.flag".
